  ...
  return (
    <div className="w-full max-w-md">
      ...
      <button
        ...
        className="w-full py-3 bg-blue-500 hover:bg-blue-600 disabled:bg-gray-300 text-white font-medium rounded-lg transition-colors mb-4"
      >
        {t('auth.login')}
      </button>
      ...
      <button
        ...
        disabled={isLoading}
        className="w-full py-3 bg-green-500 hover:bg-green-600 disabled:bg-gray-300 text-white font-medium rounded-lg transition-colors"
      >
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4">
      ...
      <div className="fixed bottom-4 text-xs text-gray-400">
        &copy; 2024 ST7 Trading Platform
      </div>
    </div>
  );
}
