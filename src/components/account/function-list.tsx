...
export function FunctionList() {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      title: t('profile.complaintEmail'),
      onClick: () => router.push(`/${locale}/complaint-email`),
    },
    {
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      onClick: () => router.push(`/${locale}/customer-service`),
    },
    {
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: t('profile.notice'),
      onClick: () => router.push(`/${locale}/notice`),
    },
    {
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
